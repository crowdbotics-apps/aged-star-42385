"""
Django settings for aged_star_42385 project.
...
ROOT_URLCONF = 'aged_star_42385.urls'
...
WSGI_APPLICATION = 'aged_star_42385.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_star_42385 API",
    "DESCRIPTION": "API documentation for aged_star_42385 App",
    "VERSION": "v1",
}
